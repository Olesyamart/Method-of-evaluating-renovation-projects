...
Для анализа используется библиотека BlocksNet, которая моделирует доступность и связанность территории через генерацию городских кварталов и дорожный граф.
 ...
 Для вычисления обеспеченности городскими сервисами используется библиотека ObjectNat, которая проводит расчет на основе вместимости сервиса и его радиуса доступности.
