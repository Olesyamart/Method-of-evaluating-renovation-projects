...
Для анализа используется библиотека BlocksNet, которая моделирует доступность и связанность территории через генерацию городских кварталов и дорожный граф.
 ...
 Обеспеченность городскими сервисами — это показатель, который отражает наличие и доступность различных городских услуг и объектов инфраструктуры. Высокий уровень обеспеченности способствует улучшению качества жизни населения. Для вычисления обеспеченности городскими сервисами используется библиотека ObjectNat, которая проводит расчет на основе вместимости сервиса и его радиуса доступности.
